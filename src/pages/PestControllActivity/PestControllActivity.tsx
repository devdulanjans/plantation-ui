...
import PestControlActivityComponent from "../../components/PestControlActivityComponent/PestControllActivityComponent";

export default function PestControllActivity() {
    return (
    <div>
      <PageMeta
