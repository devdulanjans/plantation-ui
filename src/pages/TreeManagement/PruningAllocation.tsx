...
import PruningAllocationComponent from "../../components/treeManagement/pruningAllocationComponent";

export default function PruningAllocation() {
    return (
    <div>
      <PageMeta
